...
void displayPrompt() {
    std::cout << "\n\033[1;32m" << getlogin() << "@" << getCurrentDir() << "\033[0m$ ";
}
...
int main() {
    ...
    while (true) {
        ...
        if (handleBuiltInCommands(args)) continue; // Execute built-in commands without forking
